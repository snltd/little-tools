...
mod test {
    ...
    fn test_randos_mv_noop() {
        ...
        assert!(src_dir.contains_files(3));
    ...
    fn test_randos_plain_mv() {
        ...
        assert!(src_dir.contains_files(1));
        assert!(target_dir.contains_files(2));
    }
    ...
    fn test_randos_mv_scheme_not_recursive() {
        ...
        assert!(src_dir.contains_files(2));
    ...
    fn test_randos_plain_mv_regex() {
        ...
        assert!(!src_dir.path().join("file_2.sfx").exists());
    }
